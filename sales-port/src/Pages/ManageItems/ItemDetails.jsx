...
import { mockData, mockDataForItems } from './data';
import { ItemShortDetails } from './ItemShortDetail';
    ...
    const columns = useMemo(() => [
        {
            ...
            Cell: ({ value }) => (
                <p className='item-values'>{value}</p>
            ),
        },
        {
            ...
            Cell: ({ row }) => (
                ...
                <div style={{ cursor: 'pointer', height: "100%", display: 'flex', alignItems: 'center' }} onClick={() => { handleRowClick(row.original.id, row) }}>
                    <p style={{ textAlign: 'left', color: '#222F3E', fontWeight: 500, margin: 0 }}>{row.original.transaction_number}</p>
                </div>
                // <p className='item-values'>{value}</p>
            ),
        },
        ...
        <>
            <div className="dashboard">
                ...
                <div style={{ display: "flex", justifyContent: 'space-between' }}>
                    <div >
                        <h2 className='main-heading'>Manage Items
                            {selectedOrgDetails && (
                                <>
                ...
                <div className='row mt-2'>
                  ...
                  pageCounts={pageCounts} handlePageChange={handlePageChange} selectedOrgDetails={selectedOrgDetails} data={data} /> */}
                            ...
                            <div className="col-md-3">
                                <ItemShortDetails navigate={navigate} selectedOrgDetails={selectedOrgDetails}
