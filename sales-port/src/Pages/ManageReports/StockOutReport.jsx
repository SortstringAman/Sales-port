...
import { inventoryData, stockInReportData, stockOutReportData } from './data';
...
const StockOutReport = () => {
  ...
  () => [
    ...
    },
    {
      ...
      Cell: ({ value, row }) => (
        <div className='d-flex align-items-center' style={{ gap: '9px' }}>
          <p style={{ textAlign: 'start', margin: 0,  color: '#222F3E' , fontWeight: 400, fontSize: '14px' }}>
            {value || '-'}
          </p>
    ...
    },
    {
      ...
      disableSortBy: true,
      Cell: ({ value }) => (
        <p style={{ textAlign: 'start', margin: 0, color: '#6B778C' ,fontWeight: 400, fontSize: '14px'}}>
          {value || '-'}
        </p>
      ),
    },
        ...
        <>
            <div className="dashboard">
                ...
                <div style={{ display: "flex", justifyContent: 'space-between', marginBottom: '28px' }}>
                    <div >
                        <h2 className='main-heading'>Stock Out Report</h2>
                    </div>
