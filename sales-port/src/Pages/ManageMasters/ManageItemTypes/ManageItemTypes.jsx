...
import { AddItemTypes } from '../../../Component/Modals/AddItemTypes';




const ManageItemTypes = () => {
    const [submit, setsubmit] = useState(false);
    const [currentPage, setCurrentPage] = useState(0); // Starts from 0
    const [totalCount, setTotalCount] = useState(0);
    const [studentdata, setStudentsdata] = useState([]);
    const [studentid, setstudentid] = useState([]);
    const [isaddItemTypesModal, setIsaddItemTypesModal] = useState(false);
        ...
        <>
            <div className="dashboard">
                ...
                <div style={{ display: "flex", justifyContent: 'space-between' }}>
                    <div >
                        <h2 className='main-heading'>Manage  Item Types</h2>
                    </div>
                    <div >
