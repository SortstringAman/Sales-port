...
import { AddMeasurement } from '../../../Component/Modals/AddMesureMents';
        ...
        <>
            <div className="dashboard">
                ...
                <div style={{ display: "flex", justifyContent: 'space-between' }}>
                    <div >
                        <h2 className='main-heading'>Manage  Measurements</h2>
                    </div>
                    <div >
                ...
                <div className='row mt-2'>
                    ...
                    <AddMeasurement isOpen={ismeasurementModalOpen} onClose={closeModal}/>
