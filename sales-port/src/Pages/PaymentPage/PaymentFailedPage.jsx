  ...
  return (
    <div style={styles.pageContainer}>
      <div style={styles.card}>
        <img src={PaymentRejected} alt="Payment Failed" style={styles.gif} />
        <h2 style={styles.successText}>Your Payment is Declined!</h2>

        {/* {transactionId && <p><b>Transaction ID:</b> {transactionId}</p>} */}

        <p style={styles.description}>
          We’re sorry — your payment could not be processed.
          Please ensure your payment details are correct or try again with a different method.
        </p>
