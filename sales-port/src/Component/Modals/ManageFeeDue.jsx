...
export const ManageFeeDue = ({
    isOpen, onClose, Updatebtn//selectedOrgDetails , handleFeeChange ,setFeeform ,feeForm  , handleUpdateFee,  handleChange,handleSubmitFee
