        ...
        <div className="modal-overlay">
            <div className="modal-content stock" style={{ position: 'relative', height: '80vh', overflowY: 'auto', padding: '30px' }}>
                ...
                <form onSubmit={formik.handleSubmit}>
                    ...
                    {/* Basic Information */}
                    <p className="fm-pr-hd mt-3 text-start fw-900 " style={{ textTransform: 'uppercase' }}>Stock Issuing Details</p>
                    <div className="row">
                        ...
                        <div className="col-md-4">
                            <label className="form-labell">Stock issuing to<span className='astrisk'>*</span></label>
                            <Select
                                classNamePrefix="react-select"
                                // options={vendorTypeOptions}
                                name="issuingto"
                        ...
                        <div className="col-md-4">
                            <label className="form-labell">Date of Issuing<span className='astrisk'>*</span></label>
                            <input
                                type="date"
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="purpose" rows="5" placeholder="Enter purpose"></textarea>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                <label for="remark" class="form-label">Remark</label>
                                <textarea class="form-control" id="remark" rows="5" placeholder="Enter remark"></textarea>
                            </div>
                        </div>
                    </div>
